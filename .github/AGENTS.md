...
- Use the the existing skills, especially the skills of context7 like context7-cli, conetext7-mcp or find-docs if you are missing code context or refereces.